...
import { searchProducts, allProducts, Product } from '@/lib/products';
...
const SearchPage: React.FC = () => {
  ...
  useEffect(() => {
    if (q) {
      ...
      // Use the searchProducts function from our products database
      const filtered = searchProducts(q as string, 50); // Get up to 50 results
  ...
  const categories = ['All', 'Fruits', 'Vegetables', 'Dairy', 'Snacks', 'Beverages', 'Ready to Eat', 'Meat & Fish', 'Instant Food', 'Electronics'];

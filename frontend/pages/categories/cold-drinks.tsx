...
import { Star, Plus, Clock, Truck, Coffee, ArrowLeft } from 'lucide-react';
...
const ColdDrinksPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        console.log('Fetching products for Cold Drinks category...');
        const response = await api.get('/products?category=' + encodeURIComponent('Cold Drinks'));
        
        console.log('Cold Drinks API response:', response.data);
        ...
        if (response.data.success) {
          ...
          console.log('Transformed Cold Drinks products:', transformedProducts);
          setAllProducts(transformedProducts);
        }
      } catch (error) {
        console.error('Error fetching Cold Drinks products:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <>
      <Head>
        <title>Cold Drinks - QuickSnack</title>
        <meta name="description" content="Refreshing cold drinks and beverages" />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="flex items-center justify-center mb-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-4xl font-bold text-slate-blue-gray">Cold Drinks</h1>
            ...
            {loading ? (
              <div className="text-center py-16">
                ...
                <p className="text-slate-blue-gray/70 mt-4">Loading cold drinks...</p>
              </div>
              ...
              >
                <Coffee className="w-16 h-16 text-slate-blue-gray/30 mx-auto mb-4" />
                <h3 className="text-2xl font-semibold text-slate-blue-gray mb-2">No Products Yet</h3>
                <p className="text-slate-blue-gray/70 mb-6">
                  We're working on adding refreshing cold drinks to this category. Check back soon!
                </p>
                <button
              ...
              >
                {allProducts.map((product: Product, index: number) => (
                  ...
                  >
                    ...
                    {/* Product Info */}
                    <div className="text-center mb-4">
                      <h3 className="font-semibold text-slate-blue-gray mb-2 group-hover:text-blue-500 transition-colors">
                        {product.name}
                      </h3>

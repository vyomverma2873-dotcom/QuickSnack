...
// Real beverages products matching our main products page
...
const BeveragesPage: React.FC = () => {
  ...
  const sortedProducts = sortProducts(beverageProducts);

  return (
    <>
      <Head>
        <title>Beverages - QuickSnack</title>
        <meta 
          name="description" 
          content="Shop fresh beverages with fast delivery. Juices, coffee, tea, water and more at great prices." 
        />
      </Head>
      ...
      <Layout>
        <div className="min-h-screen bg-gradient-to-br from-light-grayish-blue to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-slate-blue-gray to-sky-blue text-white mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {sortedProducts.map((product, index) => (
                ...
                >
                  {/* Product Image */}
                  <div className="h-48 bg-gradient-to-br from-slate-blue-gray to-sky-blue flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
